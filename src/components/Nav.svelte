            ...
            <div
              ...
              <div class="py-1 rounded-md bg-white shadow-xs">
                ...
                <button
                  ...
                  class="w-full text-left block px-4 py-2 text-sm leading-5
    ...
    <div class="block sm:hidden">
      ...
      <div class="pt-4 pb-3 border-t border-gray-200">
        ...
        <div
          ...
          <button
            on:click|preventDefault={handleSignOut}
            class="w-full text-left mt-1 block px-4 py-2 text-base font-medium
            text-gray-500 hover:text-gray-800 hover:bg-gray-100
            focus:outline-none focus:text-gray-800 focus:bg-gray-100 transition
            duration-150 ease-in-out"
            role="menuitem">
            Sign out
          </button>
